            ...
            <div className="login-form">
                ...
                <div className="form">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="input-container">
                            <input type="text" name="org" placeholder="organization" onChange={e => setOrganization(e.target.value)}/>
                        </div>
                        <div className="input-container">
                            <input type="text" name="zip" placeholder="zip code" pattern="[0-9]*" required onChange={e => setZip(e.target.value)}/>
                        </div>
                        <div className="input-container">
                            <input type="text" name="bio" placeholder="biography" onChange={e => setBio(e.target.value)}/>
                        </div>
